...
SWIFT_CLASS("_TtC16QuizEnglishWords11AppDelegate")
...
@property (nonatomic, weak) IBOutlet FUIButton * _Null_unspecified testBtm;
@property (nonatomic, weak) IBOutlet FUIButton * _Null_unspecified listBtm;
...
SWIFT_CLASS("_TtC16QuizEnglishWords5Wrong")
@interface Wrong : RealmSwiftObject
@property (nonatomic) NSInteger id;
@property (nonatomic, copy) NSString * _Null_unspecified question;
@property (nonatomic, copy) NSString * _Null_unspecified answer;
+ (NSString * _Nullable)primaryKey;
+ (Wrong * _Nonnull)create;
+ (NSArray<Wrong *> * _Nonnull)loadAll;
+ (NSInteger)lastId;
- (void)save;
- (void)updateWithMethod:(void (^ _Nonnull)(void))method;
- (void)delete;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
